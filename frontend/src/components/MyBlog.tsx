...
// // interface Post {
// //   _id: string;  // Changed to match MongoDB's _id format
// //   title: string;
// //   authorId: {  // Updated to match Blog.tsx structure
// //     _id: string;
// //     name: string;
// //     email: string;
// //   };
...
// //         const data = await response.json();
// //         setPosts(data); // Set the raw data directly like in Blog.tsx
// //         console.log("Fetched posts:", data);
// //       } catch (err) {
// //         setError("Error fetching posts.");
// //         console.error(err);
...
// //   // Update filtering logic to match Blog.tsx
// //   const filteredPosts = posts.filter((post) =>
...
// interface Post {
//   _id: string;  // Changed to match MongoDB
//   title: string;
//   authorId: {    // Changed to match API response
//     _id: string;
//     name: string;
//     email: string;
//   };
...
//         const postsData = data.map((post: Post) => ({
//           _id: post._id,
//           title: post.title,
//           authorId: {
...
//   // Update filtering logic to match the new structure
//   const filteredPosts = posts.filter((post) =>
//     post.authorId?.name.toLowerCase().includes(searchTerm.toLowerCase())
//   );
